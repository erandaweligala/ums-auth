...
@NamedNativeQuery(
        ...
        query = "SELECT\n" +
                ...
                "        DATE_FORMAT(u.created_datetime, '%Y-%m-%d %H:%i:%s') as createdDate\n" +
                "    FROM users u\n" +
                ...
                "        AND r.tenant_id = :tenantId\n" +
                ") total_count\n" +
                "ORDER BY CAST(t.userId AS SIGNED) DESC\n" +
...
@NamedNativeQuery(
        ...
        query = "SELECT\n" +
                ...
                "          (:userIdFilterType = 'Equal' AND CAST(u.id AS CHAR) = :userId) OR\n" +
                "          (:userIdFilterType = 'Include' AND CAST(u.id AS CHAR) LIKE CONCAT('%', :userId, '%')) OR\n" +
                ...
                "          (:nameFilterType = 'Include' AND LOWER(u.name) LIKE CONCAT('%', LOWER(:name), '%')) OR\n" +
                ...
                "          (:emailFilterType = 'Include' AND LOWER(u.email) LIKE CONCAT('%', LOWER(:email), '%')) OR\n" +
                ...
                "          (:roleNameFilterType = 'Include' AND LOWER(r.name) LIKE CONCAT('%', LOWER(:roleName), '%')) OR\n" +
                ...
                "          (:userAccountFilterType = 'Include' AND LOWER(u.user_account) LIKE CONCAT('%', LOWER(:userAccount), '%')) OR\n" +
                ...
                "          (:mobileNumberFilterType = 'Include' AND LOWER(u.mobile_number) LIKE CONCAT('%', LOWER(:mobileNumber), '%')) OR\n" +
                ...
                "          (:userTypeFilterType = 'Include' AND LOWER(u.user_type) LIKE CONCAT('%', LOWER(:userType), '%')) OR\n" +
                ...
                "          (:defaultGroupFilterType = 'Include' AND LOWER(u.default_group) LIKE CONCAT('%', LOWER(:defaultGroup), '%')) OR\n" +
                ...
                "          (:userGroupFilterType = 'Include' AND LOWER(u.associated_user_group) LIKE CONCAT('%', LOWER(:userGroup), '%')) OR\n" +
                ...
                "          (:createdDateFilterType = 'Equal' AND DATE_FORMAT(u.created_datetime, '%Y-%m-%d %H:%i:%s') = :createdDate) OR\n" +
                "          (:createdDateFilterType = 'Include' AND DATE_FORMAT(u.created_datetime, '%Y-%m-%d %H:%i:%s') LIKE CONCAT('%', :createdDate, '%')) OR\n" +
